...
function EditProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let imageUrl = formData.image ? formData.image : null;
      ...
      if (formData.image) {
        ...
        imageUrl = imgResponse.data.downloadURL;
      }
  
      const updatedFormData = { ...formData, image: imageUrl };
  
      await axios.put('http://localhost:8070/api/customer/profile', updatedFormData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <Input
              ...
              onChange={handleImageChange} // Attach image change handler
              color="lightBlue"
              size="regular"
              outline={true}
              labelProps={{
